...
namespace GeneXus.Programs {
   public class viewemployee : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewemployee( )
      {
      ...
      public viewemployee( IGxContext context )
      {
      ...
      public void execute( short aP0_EmployeeId ,
                           string aP1_TabCode )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EmployeeId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202232319564282", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewemployee.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmployeeId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmployeeId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewEMPLOYEE");
         forbiddenHiddens.Add("EmployeeName", StringUtil.RTrim( context.localUtil.Format( A20EmployeeName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewemployee:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vEMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EmployeeId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewemployee.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmployeeId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmployeeId","TabCode"})  ;
      }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "EMPLOYEE Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewEMPLOYEE.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "EMPLOYEES", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEMPLOYEE.htm");
            ...
            GxWebStd.gx_label_element( context, edtEmployeeName_Internalname, "Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEmployeeName_Internalname, StringUtil.RTrim( A20EmployeeName), StringUtil.RTrim( context.localUtil.Format( A20EmployeeName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmployeeName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEmployeeName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewEMPLOYEE.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEMPLOYEE.htm");
            /* Div Control */
      ...
      protected void START0L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View EMPLOYEE", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19EmployeeId = H000L2_A19EmployeeId[0];
               A20EmployeeName = H000L2_A20EmployeeName[0];
               AssignAttri("", false, "A20EmployeeName", A20EmployeeName);
               /* Execute user event: Load */
               E120L2 ();
      ...
      protected void STRUP0L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EmployeeId = (short)(context.localUtil.CToN( cgiGet( "vEMPLOYEEID"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewemployee:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110L2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000L3 */
         pr_default.execute(1, new Object[] {AV12EmployeeId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A19EmployeeId = H000L3_A19EmployeeId[0];
            A20EmployeeName = H000L3_A20EmployeeName[0];
            AssignAttri("", false, "A20EmployeeName", A20EmployeeName);
            AV16GXLvl6 = 1;
            Form.Caption = A20EmployeeName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwemployee.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "EMPLOYEEGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "employeegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "EMPLOYEEGeneral";
               WebComp_Generalwc_Component = "EMPLOYEEGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12EmployeeId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EmployeeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202232319564312", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewemployee.js", "?202232319564312", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmployeeId',fld:'vEMPLOYEEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A20EmployeeName',fld:'EMPLOYEENAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000L2_A19EmployeeId = new short[1] ;
         H000L2_A20EmployeeName = new string[] {""} ;
         hsh = "";
         H000L3_A19EmployeeId = new short[1] ;
         H000L3_A20EmployeeName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewemployee__default(),
            new Object[][] {
                new Object[] {
               H000L2_A19EmployeeId, H000L2_A20EmployeeName
               }
               , new Object[] {
               H000L3_A19EmployeeId, H000L3_A20EmployeeName
               }
            }
         );
      ...
      private short AV12EmployeeId ;
      private short wcpOAV12EmployeeId ;
      ...
      private short[] H000L2_A19EmployeeId ;
      private string[] H000L2_A20EmployeeName ;
      private short[] H000L3_A19EmployeeId ;
      private string[] H000L3_A20EmployeeName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12EmployeeId",GXType.Int16,4,0)
          };
          Object[] prmH000L3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000L2", "SELECT [EmployeeId], [EmployeeName] FROM [EMPLOYEE] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [EmployeeId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000L3", "SELECT [EmployeeId], [EmployeeName] FROM [EMPLOYEE] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [EmployeeId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
