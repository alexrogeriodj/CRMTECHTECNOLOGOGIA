...
namespace GeneXus.Programs {
   public class wwemployee : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwemployee( )
      {
      ...
      public wwemployee( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11EmployeeName = GetPar( "EmployeeName");
               AV12Update = GetPar( "Update");
               AV13Delete = GetPar( "Delete");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202232319564472", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwemployee.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEMPLOYEENAME", StringUtil.RTrim( AV11EmployeeName));
         /* Send saved values. */
      ...
      {
         return formatLink("wwemployee.aspx")  ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "EMPLOYEES", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWEMPLOYEE.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEMPLOYEE.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavEmployeename_Internalname, "Employee Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmployeename_Internalname, StringUtil.RTrim( AV11EmployeeName), StringUtil.RTrim( context.localUtil.Format( AV11EmployeeName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavEmployeename_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavEmployeename_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWEMPLOYEE.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Amusement Park Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Amusement Park Name") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A19EmployeeId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A20EmployeeName));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtEmployeeName_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A22EmployeeLastName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A21EmployeeAndress);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A24EmployeePhone));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A25EmployeeEmail);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A19EmployeeId = (short)(context.localUtil.CToN( cgiGet( edtEmployeeId_Internalname), ".", ","));
                              A20EmployeeName = cgiGet( edtEmployeeName_Internalname);
                              A22EmployeeLastName = cgiGet( edtEmployeeLastName_Internalname);
                              A21EmployeeAndress = cgiGet( edtEmployeeAndress_Internalname);
                              A24EmployeePhone = cgiGet( edtEmployeePhone_Internalname);
                              A25EmployeeEmail = cgiGet( edtEmployeeEmail_Internalname);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vEMPLOYEENAME"), AV11EmployeeName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_EMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A19EmployeeId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "EMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A19EmployeeId), 4, 0, ".", "")));
      }
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11EmployeeName = StringUtil.PadR( StringUtil.RTrim( AV11EmployeeName), 20, "%");
            /* Using cursor H000M2 */
            pr_default.execute(0, new Object[] {lV11EmployeeName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A7AmusementParkId = H000M2_A7AmusementParkId[0];
               n7AmusementParkId = H000M2_n7AmusementParkId[0];
               A25EmployeeEmail = H000M2_A25EmployeeEmail[0];
               A24EmployeePhone = H000M2_A24EmployeePhone[0];
               A21EmployeeAndress = H000M2_A21EmployeeAndress[0];
               A22EmployeeLastName = H000M2_A22EmployeeLastName[0];
               A20EmployeeName = H000M2_A20EmployeeName[0];
               A19EmployeeId = H000M2_A19EmployeeId[0];
               A8AmusementParkName = H000M2_A8AmusementParkName[0];
               E140M2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_EMPLOYEEID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A19EmployeeId), "ZZZ9"), context));
      }
      ...
      protected void subgrid_varsfromstate( )
      {
         if ( GridState.FilterCount >= 1 )
         {
            ...
            AssignAttri("", false, "AV11EmployeeName", AV11EmployeeName);
         }
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11EmployeeName = cgiGet( edtavEmployeename_Internalname);
            AssignAttri("", false, "AV11EmployeeName", AV11EmployeeName);
      ...
      private void E140M2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("employee.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A19EmployeeId,4,0))}, new string[] {"Mode","EmployeeId"}) ;
         edtavDelete_Link = formatLink("employee.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A19EmployeeId,4,0))}, new string[] {"Mode","EmployeeId"}) ;
         edtEmployeeName_Link = formatLink("viewemployee.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A19EmployeeId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"EmployeeId","TabCode"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20223231956456", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwemployee.js", "?20223231956456", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtEmployeeAndress_Internalname = "EMPLOYEEANDRESS_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtEmployeeAndress_Internalname = "EMPLOYEEANDRESS_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A19EmployeeId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A19EmployeeId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeName_Internalname,StringUtil.RTrim( A20EmployeeName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtEmployeeName_Link,(string)"",(string)"",(string)"",(string)edtEmployeeName_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeLastName_Internalname,StringUtil.RTrim( A22EmployeeLastName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeLastName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeAndress_Internalname,(string)A21EmployeeAndress,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A21EmployeeAndress),(string)"_blank",(string)"",(string)"",(string)edtEmployeeAndress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            {
               gxphoneLink = "tel:" + StringUtil.RTrim( A24EmployeePhone);
            }
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeePhone_Internalname,StringUtil.RTrim( A24EmployeePhone),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)gxphoneLink,(string)"",(string)"",(string)"",(string)edtEmployeePhone_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"tel",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Phone",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtEmployeeAndress_Internalname = "EMPLOYEEANDRESS";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140M2',iparms:[{av:'A19EmployeeId',fld:'EMPLOYEEID',pic:'ZZZ9',hsh:true},{av:'A7AmusementParkId',fld:'AMUSEMENTPARKID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110M2',iparms:[{av:'A19EmployeeId',fld:'EMPLOYEEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H000M2_n7AmusementParkId = new bool[] {false} ;
         H000M2_A25EmployeeEmail = new string[] {""} ;
         H000M2_A24EmployeePhone = new string[] {""} ;
         H000M2_A21EmployeeAndress = new string[] {""} ;
         H000M2_A22EmployeeLastName = new string[] {""} ;
         H000M2_A20EmployeeName = new string[] {""} ;
         H000M2_A19EmployeeId = new short[1] ;
         ...
         ROClassString = "";
         gxphoneLink = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwemployee__default(),
            new Object[][] {
                new Object[] {
               H000M2_A8AmusementParkName, H000M2_A7AmusementParkId, H000M2_n7AmusementParkId, H000M2_A25EmployeeEmail, H000M2_A24EmployeePhone, H000M2_A21EmployeeAndress, H000M2_A22EmployeeLastName, H000M2_A20EmployeeName, H000M2_A19EmployeeId
               }
               , new Object[] {
      ...
      private string A20EmployeeName ;
      private string edtEmployeeName_Link ;
      private string A22EmployeeLastName ;
      private string A24EmployeePhone ;
      ...
      private string edtEmployeeAndress_Internalname ;
      ...
      private string edtEmployeeAndress_Jsonclick ;
      ...
      private string A21EmployeeAndress ;
      private string A25EmployeeEmail ;
      ...
      private bool[] H000M2_n7AmusementParkId ;
      private string[] H000M2_A25EmployeeEmail ;
      private string[] H000M2_A24EmployeePhone ;
      private string[] H000M2_A21EmployeeAndress ;
      private string[] H000M2_A22EmployeeLastName ;
      private string[] H000M2_A20EmployeeName ;
      private short[] H000M2_A19EmployeeId ;
   ...
   public class wwemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000M2( IGxContext context ,
                                             string AV11EmployeeName ,
                                             string A20EmployeeName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[AmusementParkName], T1.[AmusementParkId], T1.[EmployeeEmail], T1.[EmployeePhone], T1.[EmployeeAndress], T1.[EmployeeLastName], T1.[EmployeeName], T1.[EmployeeId]";
         sFromString = " FROM ([EMPLOYEE] T1 LEFT JOIN [AmusementPark] T2 ON T2.[AmusementParkId] = T1.[AmusementParkId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11EmployeeName)) )
         {
            AddWhere(sWhereString, "(T1.[EmployeeName] like @lV11EmployeeName)");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000M2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H000M3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11EmployeeName",GXType.NChar,20,0) ,
