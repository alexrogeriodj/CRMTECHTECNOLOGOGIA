...
namespace GeneXus.Programs {
   public class wwamusementpark : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202232319564338", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWAmusementPark.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAmusementparkname_Internalname, StringUtil.RTrim( AV11AmusementParkName), StringUtil.RTrim( context.localUtil.Format( AV11AmusementParkName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Park Name", edtavAmusementparkname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavAmusementparkname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAmusementPark.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Park Andress") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A10AmusementParkAndress);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( A11AmusementParkPhoto));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A12CountryId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A13CountryName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A26CityId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A27CityName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A10AmusementParkAndress = cgiGet( edtAmusementParkAndress_Internalname);
                              A11AmusementParkPhoto = cgiGet( edtAmusementParkPhoto_Internalname);
                              AssignProp("", false, edtAmusementParkPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A11AmusementParkPhoto)) ? A40000AmusementParkPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A11AmusementParkPhoto))), !bGXsfl_25_Refreshing);
                              ...
                              A26CityId = (short)(context.localUtil.CToN( cgiGet( edtCityId_Internalname), ".", ","));
                              n26CityId = false;
                              A27CityName = cgiGet( edtCityName_Internalname);
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11AmusementParkName = StringUtil.PadR( StringUtil.RTrim( AV11AmusementParkName), 40, "%");
            /* Using cursor H000H2 */
            ...
            {
               A27CityName = H000H2_A27CityName[0];
               A26CityId = H000H2_A26CityId[0];
               n26CityId = H000H2_n26CityId[0];
               A13CountryName = H000H2_A13CountryName[0];
               A12CountryId = H000H2_A12CountryId[0];
               A40000AmusementParkPhoto_GXI = H000H2_A40000AmusementParkPhoto_GXI[0];
               AssignProp("", false, edtAmusementParkPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A11AmusementParkPhoto)) ? A40000AmusementParkPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A11AmusementParkPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtAmusementParkPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A11AmusementParkPhoto), true);
               A10AmusementParkAndress = H000H2_A10AmusementParkAndress[0];
               A9AmusementParkWebsite = H000H2_A9AmusementParkWebsite[0];
               A8AmusementParkName = H000H2_A8AmusementParkName[0];
               A7AmusementParkId = H000H2_A7AmusementParkId[0];
               A11AmusementParkPhoto = H000H2_A11AmusementParkPhoto[0];
               AssignProp("", false, edtAmusementParkPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A11AmusementParkPhoto)) ? A40000AmusementParkPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A11AmusementParkPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtAmusementParkPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A11AmusementParkPhoto), true);
               A13CountryName = H000H2_A13CountryName[0];
               A27CityName = H000H2_A27CityName[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AMUSEMENTPARKID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A7AmusementParkId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202232319564391", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwamusementpark.js", "?202232319564392", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtAmusementParkAndress_Internalname = "AMUSEMENTPARKANDRESS_"+sGXsfl_25_idx;
         edtAmusementParkPhoto_Internalname = "AMUSEMENTPARKPHOTO_"+sGXsfl_25_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_25_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_25_idx;
         edtCityId_Internalname = "CITYID_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtAmusementParkAndress_Internalname = "AMUSEMENTPARKANDRESS_"+sGXsfl_25_fel_idx;
         edtAmusementParkPhoto_Internalname = "AMUSEMENTPARKPHOTO_"+sGXsfl_25_fel_idx;
         edtCountryId_Internalname = "COUNTRYID_"+sGXsfl_25_fel_idx;
         edtCountryName_Internalname = "COUNTRYNAME_"+sGXsfl_25_fel_idx;
         edtCityId_Internalname = "CITYID_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmusementParkAndress_Internalname,(string)A10AmusementParkAndress,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A10AmusementParkAndress),(string)"_blank",(string)"",(string)"",(string)edtAmusementParkAndress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCountryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12CountryId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12CountryId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCountryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCityId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A26CityId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A26CityId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCityId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtAmusementParkAndress_Internalname = "AMUSEMENTPARKANDRESS";
      ...
      public override void initialize_properties( )
      {
         ...
         edtAmusementParkAndress_Jsonclick = "";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140H2',iparms:[{av:'A7AmusementParkId',fld:'AMUSEMENTPARKID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAmusementParkName_Link',ctrl:'AMUSEMENTPARKNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'A7AmusementParkId',fld:'AMUSEMENTPARKID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H000H2_A27CityName = new string[] {""} ;
         H000H2_A26CityId = new short[1] ;
         H000H2_n26CityId = new bool[] {false} ;
         H000H2_A13CountryName = new string[] {""} ;
         H000H2_A12CountryId = new short[1] ;
         H000H2_A40000AmusementParkPhoto_GXI = new string[] {""} ;
         H000H2_A10AmusementParkAndress = new string[] {""} ;
         H000H2_A9AmusementParkWebsite = new string[] {""} ;
         H000H2_A8AmusementParkName = new string[] {""} ;
         H000H2_A7AmusementParkId = new short[1] ;
         H000H2_A11AmusementParkPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwamusementpark__default(),
            new Object[][] {
                new Object[] {
               H000H2_A27CityName, H000H2_A26CityId, H000H2_n26CityId, H000H2_A13CountryName, H000H2_A12CountryId, H000H2_A40000AmusementParkPhoto_GXI, H000H2_A10AmusementParkAndress, H000H2_A9AmusementParkWebsite, H000H2_A8AmusementParkName, H000H2_A7AmusementParkId,
               H000H2_A11AmusementParkPhoto
               }
               , new Object[] {
      ...
      private string edtAmusementParkAndress_Internalname ;
      ...
      private string edtAmusementParkAndress_Jsonclick ;
      ...
      private bool n26CityId ;
      private bool gxdyncontrolsrefreshing ;
      private bool returnInSub ;
      private bool gx_refresh_fired ;
      private bool A11AmusementParkPhoto_IsBlob ;
      private string A10AmusementParkAndress ;
      ...
      private string[] H000H2_A27CityName ;
      private short[] H000H2_A26CityId ;
      private bool[] H000H2_n26CityId ;
      private string[] H000H2_A13CountryName ;
      private short[] H000H2_A12CountryId ;
      private string[] H000H2_A40000AmusementParkPhoto_GXI ;
      private string[] H000H2_A10AmusementParkAndress ;
      private string[] H000H2_A9AmusementParkWebsite ;
      private string[] H000H2_A8AmusementParkName ;
      private short[] H000H2_A7AmusementParkId ;
      private string[] H000H2_A11AmusementParkPhoto ;
   ...
   public class wwamusementpark__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A8AmusementParkName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[CityName], T1.[CityId], T2.[CountryName], T1.[CountryId], T1.[AmusementParkPhoto_GXI], T1.[AmusementParkAndress], T1.[AmusementParkWebsite], T1.[AmusementParkName], T1.[AmusementParkId], T1.[AmusementParkPhoto]";
         sFromString = " FROM (([AmusementPark] T1 INNER JOIN [Paises] T2 ON T2.[CountryId] = T1.[CountryId]) LEFT JOIN [PaisesCity] T3 ON T3.[CountryId] = T1.[CountryId] AND T3.[CityId] = T1.[CityId])";
         sOrderString = "";
                                             ...
                                             string A8AmusementParkName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([AmusementPark] T1 INNER JOIN [Paises] T2 ON T2.[CountryId] = T1.[CountryId]) LEFT JOIN [PaisesCity] T3 ON T3.[CountryId] = T1.[CountryId] AND T3.[CityId] = T1.[CityId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11AmusementParkName)) )
         {
            AddWhere(sWhereString, "(T1.[AmusementParkName] like @lV11AmusementParkName)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000H2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H000H3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11AmusementParkName",GXType.NChar,40,0) ,
